...
public class BadEyesTagProviders {
    ...
    public static class BadEyesItemTagProvider extends ItemTagsProvider {
        ...
        public BadEyesItemTagProvider(PackOutput p_255871_, CompletableFuture<HolderLookup.Provider> p_256035_, TagsProvider<Block> p_256467_, String modId, @Nullable ExistingFileHelper existingFileHelper) {
